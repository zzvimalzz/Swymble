...
|---|---|---|---|
| `home/` | `branding.ts`, `socials.ts`, `whatido.ts`, `latestupdates.ts`, `services.ts`, `process.ts`, `universe.ts` | homepage sections (branding and socials are also used site-wide in nav/footer) | [home/README.md](home/README.md) |
