...
import { resolveMediaUrl } from '../../../../../utils/misc'
...
export const FilmView = ({
  ...
  useEffect(() => {
    if (filmRef.current?.uid !== film?.uid) {
        ...
        >
          {!isIOS && (
            <img
              ...
              alt=''
              src={resolveMediaUrl(config.backdropBaseUrl, film.backdrop)}
              onLoad={() => {
