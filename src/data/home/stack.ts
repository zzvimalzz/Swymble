...
export const SWYMBLE_TECH_STACK_SECTION: SwymbleTechStack = {
  ...
  tools: [
    ...
    { id: 'nextjs', name: 'Next.js', icon: '/images/stack_icons/nextjs.png' },
    ...
    { id: 'mongodb', name: 'MongoDB', icon: '/images/stack_icons/mongodb.png' },
    { id: 'redis', name: 'Redis', icon: '/images/stack_icons/redis.png' },
    { id: 'aws', name: 'AWS', icon: '/images/stack_icons/aws.png' },
